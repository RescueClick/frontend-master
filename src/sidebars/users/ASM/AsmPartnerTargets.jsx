...
import { Target, FileText, IndianRupee, Search, Edit, Save, X, Calendar, CheckCircle, XCircle } from "lucide-react";
import { useDispatch, useSelector } from "react-redux";
import { fetchPartnerTargets, assignPartnerTarget } from "../../../feature/thunks/asmThunks";
import toast from "react-hot-toast";

const AsmPartnerTargets = () => {
  ...
  const { data: partnerTargets = [], loading } = useSelector(
    (state) => state.asm?.partnerTargets || { data: [], loading: false }
  );
    ...
    <div className="min-h-screen bg-slate-50 p-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-6">
          ...
          <p className="text-gray-600">Manage and assign targets for partners in your region</p>
        </div>
                      ...
                      <td className="px-6 py-4">
                        {editingPartner === partner.partnerId ? (
                          <input
                            ...
                            className="w-20 px-2 py-1 border border-gray-300 rounded focus:ring-2 focus:ring-brand-primary"
                            min="1"
                          />
                        ) : (
                        ...
                        {editingPartner === partner.partnerId ? (
                          <div className="relative">
                            ...
                            <input
                              ...
                              className="w-32 pl-8 pr-2 py-1 border border-gray-300 rounded focus:ring-2 focus:ring-brand-primary"
                              min="0"
                              step="10000"
                            />
                          </div>
...
export default AsmPartnerTargets;
