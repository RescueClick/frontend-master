...
import { fetchRsmPartnerTargets } from "../../../feature/thunks/rsmThunks";

const RsmPartnerTargets = () => {
  ...
  const { data: partnerTargets = [], loading } = useSelector(
    (state) => state.rsm?.partnerTargets || { data: [], loading: false }
  );

  useEffect(() => {
    dispatch(fetchRsmPartnerTargets({ year, month }));
  }, [dispatch, year, month]);
    ...
    <div className="min-h-screen bg-slate-50 p-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-6">
          ...
          <p className="text-gray-600">View partner targets and achievements in your region</p>
        </div>
...
export default RsmPartnerTargets;
