...
const AdminDonePayout = () => {
  ...
  const handleSubmitPayout = async (e) => {
    ...
    try {
      ...
      toast.success(
        modalForm.payOutStatus === "DONE" && modalForm.sendInvoiceEmail
          ? "Payout updated! Section 194T tax invoice & statement emailed to partner."
  ...
  const handleExportXlsx = () => {
    if (!sortedRows.length) {
      toast.error("No settled payout records to export");
      return;
    }
    ...
    downloadXlsx(exportRows, "Settled-Payouts.xlsx", "Settled Payouts");
    toast.success("Settled payouts exported to Excel!");
  };
  ...
  const columns = useMemo(
    () => [
      ...
      },
      {
        ...
        render: (_, r) => (
          <div className="flex flex-col gap-1">
            <span
              className={`inline-flex items-center w-fit px-2.5 py-0.5 rounded-full text-[11px] font-semibold ${payoutLoanTypePillClass(
                r.loanType
              )}`}
            >
      ...
      },
      {
        ...
        width: 120,
        render: (_, r) => (
          <PayoutStatusBadge status={r.payOutStatus || "DONE"} />
        ),
      },
      {
          ...
          return (
            <div className="flex items-center gap-1.5">
              <button
                ...
                className="px-2.5 py-1.5 rounded-lg text-xs font-bold bg-slate-100 hover:bg-slate-200 text-slate-700 border border-slate-200 shadow-sm flex items-center gap-1 transition"
                title="View / Edit Payout"
              >
              ...
              <div className="flex items-center gap-2.5">
                ...
                <div>
                  <h3 className="text-sm font-bold text-white flex items-center gap-2">
                    <span>Payout Details &amp; Receipt</span>
                ...
                <div className="space-y-3">
                  <div className="flex items-center justify-between border-b border-slate-200/80 pb-2">
                    <div className="flex items-center gap-1.5 text-slate-900 font-bold text-xs">
                      ...
                      <span>Settled Commission &amp; Section 194T TDS Plan</span>
                    </div>
...
export default AdminDonePayout;
