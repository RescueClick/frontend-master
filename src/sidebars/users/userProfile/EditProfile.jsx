  ...
  const handleSave = async () => {
    ...
    try {
      ...
      if (passwordForm.newPassword) {
        ...
        if (pwOk) {
          extraMsg = " and password";
        }
      }

      setSaveMsg({ type: "ok", text: `Profile${extraMsg} saved successfully.` });
                ...
                {isAdmin ? (
                  <div className="mb-5 p-3.5 bg-teal-50/80 border border-teal-200/80 rounded-xl text-xs text-teal-900">
                    <div className="flex items-center justify-between flex-wrap gap-2">
                      <p>
                        🔑 <strong>Admin Privilege:</strong> You can set a new password directly for this {roleLabel}. Current password is not required.
                      </p>
                      <button
                        type="button"
