...
import HomeLoanSalaried from "./HomeLoanSalaried";
import HomeLoanSelfEmployee from "./HomeLoanSelfEmployee";
import { User, Store } from "lucide-react";

export default function HomeLoan({ embed = false } = {}) {
  ...
  return (
    <div className="w-full">
      ...
      {activeTab === "salaried" ? (
        <HomeLoanSalaried embed={embed} />
      ) : (
        <HomeLoanSelfEmployee embed={embed} />
      )}
    </div>
  );
}
