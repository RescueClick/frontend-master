  ...
  return (
    <div className="flex h-screen w-full bg-gray-50 overflow-hidden">
      ...
      <div className="flex-1 flex flex-col min-w-0 h-full overflow-y-auto overflow-x-hidden">
            ...
            <div className="flex items-center space-x-2 sm:space-x-3 shrink-0">
              ...
              <div className="relative">
                <button
                  ...
                  className="cursor-pointer flex items-center space-x-2 sm:space-x-3 p-1.5 sm:p-2 rounded-lg hover:bg-gray-100 transition-colors"
                >
                  <div className="w-8 h-8 sm:w-9 sm:h-9 rounded-full bg-gradient-to-r from-teal-500 to-teal-600 flex items-center justify-center text-white font-semibold shadow-sm text-xs sm:text-sm">
        ...
        {/* Content Area */}
        <main className="flex-1 p-2 sm:p-3 md:p-6 bg-gray-50 overflow-y-auto min-w-0">
          <Suspense
            fallback={
